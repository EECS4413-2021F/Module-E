...
@Component({
  selector: 'app-provincial-tax-view-v1',
  styles: [`
  ...
  template: `
    <ng-template [ngIf]="tax">
      <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a routerLink="/v1" class="text-decoration-none">Provinces</a></li>
...
export class ProvincialTaxViewComponent_V1 implements OnInit {
